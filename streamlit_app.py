# ==============================================================================
#      NİHAİ KOD (v15.1): Stabil Durum Yönetimi ve Derin Analiz Revizyonu
# ==============================================================================
...
# ------------------------------------------------------------------------------
# GÜNCELLEME: Bu prompt, AI'ı aktif araştırmaya ve OKUMAYA zorlar.
...
# ... Diğer AI ve veritabanı fonksiyonları (v15.0 ile aynı, değişiklik yok)
# (discover_events, group_similar_events, find_neighboring_facilities, check_event_exists, save_report_to_db, get_all_reports_from_db)
# Bu fonksiyonları bir önceki yanıttan alabilirsiniz. Okunabilirlik için buraya tekrar ekliyorum:
...
# ------------------------------------------------------------------------------
# 3. ARAYÜZ VE DURUM YÖNETİMİ (STATE MACHINE)
# ------------------------------------------------------------------------------
                    ...
                    if kaynak_linkleri:
                        for link in kaynak_linkleri:
                            if isinstance(link, str):
                                st.markdown(f"- {link}")
                            elif isinstance(link, dict) and 'url' in link: # Düzeltilmiş hata yönetimi
